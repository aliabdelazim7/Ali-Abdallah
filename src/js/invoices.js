...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (window.appState && !window.appState.suspendedCarts) {
    try {
      const saved = localStorage.getItem("ali_suspended_carts");
...
function suspendActiveCart() {
  ...
  localStorage.setItem("ali_suspended_carts", JSON.stringify(window.appState.suspendedCarts));
...
window.restoreSuspendedCart = function(id) {
  ...
  localStorage.setItem("ali_suspended_carts", JSON.stringify(carts));
