...
const API_CONFIG_KEY = "ali_system_settings";
const LOCAL_DB_KEY = "ali_local_database";

const isDemoActive = () => localStorage.getItem("ali_demo_mode") === "true" || sessionStorage.getItem("ali_demo_mode") === "true";
...
const defaultSettings = {
  ...
  phone: "+201018907086",
  currency: "EGP",
  adminEmail: "admin@aliabdullah.com",
  adminPassword: "Ali2026_Secure",
  settingsPassword: "ali_settings"
};
...
class ApiService {
  ...
  loadConfig() {
    ...
    const configKey = isDemoMode ? "ali_demo_settings" : API_CONFIG_KEY;
  ...
  loadLocalDb() {
    const isDemoMode = isDemoActive();
    const dbKey = isDemoMode ? "ali_demo_database" : LOCAL_DB_KEY;
  ...
  getPendingQueue() {
    try {
      const saved = localStorage.getItem("ali_pending_sync");
  ...
  savePendingQueue(queue) {
    localStorage.setItem("ali_pending_sync", JSON.stringify(queue));
  }
